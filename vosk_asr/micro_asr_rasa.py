...
class VoskMicroServer():
    ...
    def __init__(self, config):
        ...
        self.topic = self.pid + '/asr_result'
        self.nlu_topic = self.pid + '/nlu'
        if self.language:
            self.topic += '/' + self.language
            self.nlu_topic += '/' + self.language
    ...
    def check_result(self, transcribe):
        ...
        if data and 'text' in data:
            ...
            if text != '' and text != 'einen' and text != 'bin' and text != 'the':
                ...
                # Send to rasa and return result
                response = requests.post(self.rasa_url, json=data)
                self.client.publish(self.nlu_topic,
