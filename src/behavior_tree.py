...
class BehaviourTree(pt.trees.BehaviourTree):
    def __init__(self):        
        ...
        self.auto_pack_class = AutoPackClass(name="auto_pack_class", rdf=self.rdf, gui=self.gui, vision=self.vision, frame_id = 15, pack_state=self.pack_state, robot=self.robot, pack_height=self.pack_height)
        ...
        self.helped_locate_pack = HelpedLocatePack(name="helped_locate_pack", rdf=self.rdf, pack_state=self.pack_state, gui=self.gui, frame_id = 17, vision=self.vision, robot=self.robot, pack_height=self.pack_height)
        ...
        self.auto_cell_class = AutoCellClass(name="auto_cell_class", rdf=self.rdf, pack_state=self.pack_state, robot=self.robot, pack_height=self.pack_height, vision=self.vision, gui=self.gui, frame_id = 1)
